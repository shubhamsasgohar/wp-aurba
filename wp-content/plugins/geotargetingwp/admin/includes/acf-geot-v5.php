			...
			if ( 'regions' == $field['geot_show'] ) {
				...
				if ( is_array( $regions ) ) {
					...
					create_field( [
						...
						'value'    => isset($field['value']) && isset( $field['value']['geot_regions'] ) ? $field['value']['geot_regions'] : '',
						'choices'  => $choices,
					] );
					echo '</div>';
				} else { ?>
				...
				if ( is_array( $regions ) ) {
					...
					create_field( [
						...
						'value'    => isset( $field['value']['geot_state_regions'] ) ? $field['value']['geot_state_regions'] : '',
						'choices'  => $choices,
					] );
					echo '</div>';
				} else { ?>
				...
				if ( is_array( $regions ) ) {
					...
					create_field( [
						...
						'value'    => isset( $field['value']['geot_zip_regions'] ) ? $field['value']['geot_zip_regions'] : '',
						'choices'  => $choices,
					] );
					echo '</div>';
				} else { ?>
