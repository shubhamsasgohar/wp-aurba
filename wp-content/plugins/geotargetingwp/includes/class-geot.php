...
class Geot {
	...
	/**
	 * GeotWP_Navigations
	 * @var null|GeotWP_Navigations $navigations
	 */
	public ?GeotWP_Navigations $navigations = null;
	/**
	...
	private function load_dependencies() {
		...
		require_once GEOWP_PLUGIN_DIR . 'includes/3rd-party/Geot_Mobile_Detect.php';
		...
		require_once GEOWP_PLUGIN_DIR . 'admin/includes/class-geot-navigations.php';
