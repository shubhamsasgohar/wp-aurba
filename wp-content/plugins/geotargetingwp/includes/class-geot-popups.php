...
class Geot_Popups {
	public function __construct() {
		...
		add_action( 'spu/rules/print_geot_radius_field', [ 'Spu_Helper', 'print_textfield' ], 10, 1 );
		...
		add_filter( 'wppopups_output_field_geot_radius_region', [ $this, 'field_region' ], 10, 2 );
		add_filter( 'wppopups_sanitize_field_geot_state_region', [ $this, 'sanitize_region' ], 10, 4 );
	}
