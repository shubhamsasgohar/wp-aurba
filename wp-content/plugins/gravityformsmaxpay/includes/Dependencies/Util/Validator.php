...
use GF_Maxpay\Dependencies\Exception\EmptyArgumentException;
use GF_Maxpay\Dependencies\Exception\GeneralMaxpayException;
use GF_Maxpay\Dependencies\Exception\InvalidStringLengthException;
use GF_Maxpay\Dependencies\Exception\NotNumericException;
