		...
		if ( isset( $_POST['geot_nonce'] ) && wp_verify_nonce( $_POST['geot_nonce'], 'geot_pro_save_settings' ) ) {
			...
			if ( isset( $_POST['geot_settings'] ) ) {
				...
				if( is_array($settings) ) {
					...
					if( empty( $settings['disable_remove_post'] ) ) {
						$settings['disable_remove_post'] = '';
					}
				}
...
*/
	...
	public function setup_wizard_addons() {
		...
		require_once GEOWP_PLUGIN_DIR . 'includes/geot/Setting/partials/setup-wizard-addons.php';
	}
	...
	public function setup_wizard_others() {
		...
		require_once GEOWP_PLUGIN_DIR . 'includes/geot/Setting/partials/setup-wizard-others.php';
	}
